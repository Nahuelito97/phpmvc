...
<section class="full-box nav-lateral">
    ...
    <div class="full-box nav-lateral-content">
        <figure class="full-box nav-lateral-avatar">
            ...
            <img src="<?php echo SERVERURL; ?>view/assets/avatar/webdev.png" class="img-fluid" alt="Avatar">
            <figcaption class="roboto-medium text-center">
                Wagner Nahuel <br><small class="roboto-condensed-light">Web Developer</small>
            </figcaption>
        </figure>
